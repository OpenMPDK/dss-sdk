...
import common.clusterlib.lib_constants
from common.etcdlib import etcd_api
from common.events.events_def_en import events, event_type
from common.events.events import get_events_from_etcd_db
from common.clusterlib.lib_exceptions import EtcdConnectionFail
...
def create_db_connection(ip_address='127.0.0.1', module_name='cluster_api',
    ...
    if not log:
        try:
            log = ufmlog.log(module=__name__, mask=ufmlog.UFM_DB)
