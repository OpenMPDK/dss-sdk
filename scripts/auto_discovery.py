...
class AutoDiscovery:
    ...
    def nvme_discover(self, transporter=None, address=None, port=None):
        ...
        if transporter and address and port:
            ...
            ret, result = exec_cmd(nvme_discover_command)
    ...
    def  get_nvme_mount_dir(self):
        ...
        #print("DEBUG: NVME mount dir {}".format(self.nqn_ip_port_to_remote_nvme))

    @exception
    def get_remote_mount_paths(self):

        #print("DEBUG: Get Remote Mount Paths ...")
