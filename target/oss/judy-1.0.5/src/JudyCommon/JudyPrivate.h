...
#define cJU_UNSIGNED_ONE 	((Word_t)1)
#define cJU_UNSIGNED_ZERO 	((Word_t)0)
#define cJU_SIGNED_ONE 		((SWord_t)1)
#define cJU_SIGNED_ZERO 	((SWord_t)0)


// A word that is all-ones, normally equal to -1UL, but safer with ~0:
#define cJU_ALLONES  		(~cJU_UNSIGNED_ZERO)
...
#define SEARCHLEAFNATIVE(LEAFTYPE,ADDR,POP1,INDEX)              \
    ...
    Word_t   h_igh  = POP1;                                     \
                                                                \
																    while ((h_igh - l_ow) > cJU_UNSIGNED_ONE)                   \
																	    {                                                           \
        m_id = (h_igh + l_ow) / 2;                              \
...
#define JU_BITPOSMASKB(BITNUM) (cJU_SIGNED_ONE << ((BITNUM) % cJU_BITSPERSUBEXPB))
#define JU_BITPOSMASKL(BITNUM) (cJU_SIGNED_ONE << ((BITNUM) % cJU_BITSPERSUBEXPL))
