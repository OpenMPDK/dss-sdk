...
#define JU_BRANCHL_MAX_POP      (-cJU_UNSIGNED_ONE)
#define JU_BTOU_POP_INCREMENT      300
#define JU_BRANCHB_MIN_POP        1000
#define JU_BRANCHB_MAX_POP      (-cJU_UNSIGNED_ONE)
...
#endif
{
        ...
        *PoIndex = (Word_t)((((Word_t)91) << 56) | (((Word_t)92) << 48) | (((Word_t)93) << 40) | (((Word_t)94) << 32)
