...
Word_t j__uMaxWords = ~cJU_UNSIGNED_ZERO;
...
#define MALLOC(MallocFunc,WordsPrev,WordsNow) \
        (((WordsPrev) > j__uMaxWords) ? cJU_UNSIGNED_ZERO : MallocFunc(WordsNow))
...
#define ZEROWORDS(Addr,Words)                   \
        {                                       \
            ...
            while (Words__--) *Addr__++ = cJU_UNSIGNED_ZERO;  \
        }
...
static Word_t j__udyMemSequence = (Word_t)0L;   // event sequence number.

#define TRACE_ALLOC5(a,b,c,d,e)   (void) JudyPrintf(a, (b), c, d)
#define TRACE_FREE5( a,b,c,d,e)   (void) JudyPrintf(a, (b), c, d)
#define TRACE_ALLOC6(a,b,c,d,e,f) (void) JudyPrintf(a, (b), c, d, e)
#define TRACE_FREE6( a,b,c,d,e,f) (void) JudyPrintf(a, (b), c, d, e)
...
#define TRACE_ALLOC5(a,b,c,d,e)   \
    (void) JudyPrintf("a %lx %lx %lx\n", (b), (d) * b_pw, e)
#define TRACE_FREE5( a,b,c,d,e)   \
    (void) JudyPrintf("f %lx %lx %lx\n", (b), (d) * b_pw, e)
